		...
		if (queryId != null) {
			...
			if (query != null) {
				try {
					...
					redirectAttributes.addFlashAttribute("success", "success.deletingNewQuery");
					
				} catch (Throwable e) {
					redirectAttributes.addFlashAttribute("error", "error.deletingQuery");
				}
			}
		}
...
//		return "queryList";
	...
	public String saveOrUpdateQuery(@ModelAttribute("query") Query query,@RequestParam("action") String action,
			Map<String, Object> map, HttpServletRequest request,
